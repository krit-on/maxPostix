 ...
 * Update an Item
 */
class maxPosterixItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('maxposterix_item_err_ns');
		}
...
return 'maxPosterixItemUpdateProcessor';
